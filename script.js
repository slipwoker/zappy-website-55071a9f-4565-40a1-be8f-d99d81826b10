    ...
    if (contactForm) {
        ...
        function validateMessage(message) {
            ...
            if (message.trim().length < 10) {
                return errorMessages.message.minLength;
            }
            return null;
        }
        ...
        function validateField(input) {
            ...
            } else if (input.tagName === 'TEXTAREA' || fieldName === 'message') {
                error = validateMessage(input.value);
            } else if (input.type === 'text' || fieldName === 'name') {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            const nameInput = contactForm.querySelector('input[name="name"], input[id*="name"], input[type="text"]');
            const emailInput = contactForm.querySelector('input[name="email"], input[id*="email"], input[type="email"]');
            const messageInput = contactForm.querySelector('textarea[name="message"], textarea[id*="message"], textarea');
            ...
            if (isValid) {
                ...
                .catch(error => {
                    ...
                    errorMsg.style.cssText = 'color: #dc3545; padding: 1rem; margin-top: 1rem; background: #f8d7da; border-radius: 4px;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f357de58-57a7-4955-bda0-ed214b456b21',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f357de58-57a7-4955-bda0-ed214b456b21';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '55071a9f-4565-40a1-be8f-d99d81826b10';
